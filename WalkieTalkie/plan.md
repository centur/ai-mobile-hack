...
- Installed language selectors read the device's actual `SpeechTranscriber.installedLocales` inventory through the Apple provider, discard invalid/undefined identifiers, and expose only app-owned `Language` values to the feature layer.
